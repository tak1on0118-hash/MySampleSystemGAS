...
---
**＜スプレッドシート・テンプレートの取得＞**     
本システムを動作させるためのスプレッドシート（帳票レイアウト）のひな形を用意しています。以下のリンクからプレビューを確認し、ご自身のGoogleドライブにコピーしてご利用いただけます。

* **Googleフォームのテンプレート**
  [コピーして使用する](https://docs.google.com/forms/d/16YuFEZx3vDfO-ReMBUnoNX1TwTpMQabML4vqhtiU2h8/copy)
* **レイアウト用のテンプレート**
  [コピーして使用する](https://docs.google.com/spreadsheets/d/1u3-8Jv2pROXcsqJQu3aDJ23PZEW7JjK9jUSlpDm5CpA/copy)

**サンプルデータ**
* [フォームの回答例（スプレッドシート）](https://docs.google.com/spreadsheets/d/17KYTweK7eIakwSsqACT8WEn6pnkPgApl7CrlJjNL5Bs/copy)
* [報告書ファイル例（スプレッドシート）](https://docs.google.com/spreadsheets/d/1LPYOVGY0t6KxnyUW2oSCUW4N8UG_hLihvSqt824A-is/copy)
